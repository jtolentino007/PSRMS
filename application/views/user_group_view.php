            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta){
                        ...
                        var btn_rights='<button class="btn btn-danger btn-sm" name="remove_info" style="margin-right:0px;" data-toggle="tooltip" data-placement="top" title="Setup User Rights"><i class="fa fa-gear"></i> Setup User Rights</button>';
