...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        ...
        var products = new Bloodhound({
            datumTokenizer: Bloodhound.tokenizers.obj.whitespace('ingredient_name','product_desc'),
        ...
        _objTypeHead.typeahead(null, {
            ...
            templates: {
                ...
                suggestion: Handlebars.compile('<table width="100%"><tr><td width="30%" align="left">{{ingredient_name}}</td><td width="20%" align="right" style="padding-right: 2%;">{{unit_name}}</td><td hidden width="20%" align="left">{{ingredient_category_name}}</td></tr></table>')
