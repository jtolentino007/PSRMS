                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div id="div_user_fields" style="display: none;">
                                        ...
                                        <!-- Modal -->
                                        <div id="modal_users" class="modal fade" role="dialog">
                                          <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <div class="row">
                                                  <div class="container-fluid">
                                                      <form id="frm_users" role="form">
                                                        <div class="col-xs-12 col-sm-4">
                                                           <div class="input-group">
                                                               <div class="" style="height: 230px;width: 210px;vertical-align: middle;">
                                                                   <div id="div_img_user" style="position:relative;">
                                                                       <img name="img_user" src="assets/img/anonymous-icon.png" style="object-fit: fill; !important; height: 100%;width: 100%; border-radius: 50%; border: 2px solid #ddd;" />
                                                               ...
                                                               <button type="button" id="btn_browse" class="btn btn-primary btn-block" style="text-transform: capitalize;">BROWSE</button>
                                                               <button type="button" id="btn_remove_photo"  class="btn btn-danger btn-block" style="text-transform: capitalize; margin-top: 5px;">REMOVE</button>
                                                           </div>
                                                        </div>
                                                        <div class="col-xs-12 col-sm-4">
...
<script>
    $(document).ready(function(){
        ...
        var initializeControls=function(){
            ...
            _cboUserGroup.select2({ dropdownParent: "#modal_users" });
        }();
