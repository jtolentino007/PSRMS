...
<?php
	...
	$query = $this->db->query('SELECT 
			...
			LEFT JOIN customers ON pos_invoice.customer_id=customers.customer_id WHERE user_id='.$user_id.' AND pos_invoice.transaction_date BETWEEN "'.$sDate.'" AND "'.$eDate.'" GROUP BY pos_invoice_id');
	$gtotal = $query->row();
