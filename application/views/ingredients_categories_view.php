    ...
    $(document).ready(function(){
        ...
        var initializeControls=function(){
            dt=$('#tbl_categories').DataTable({
                "dom": '<"toolbar">frtip',
                "bLengthChange":false,
                "ajax" : "Ingredients_categories/transaction/list",
                "columns": [

                    { targets:[0],data: "ingredient_category_name" },
                    {
                        targets:[1],
        ...
        var bindEventHandlers=(function(){
            ...
            $('#tbl_categories tbody').on('click','button[name="edit_info"]',function(){
                ...
                _selectedID=data.ingredient_category_id;
        ...
        var updateCategory=function(){
            var _data=$('#frm_category').serializeArray();
            _data.push({name : "ingredient_category_id" ,value : _selectedID});

            return $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Ingredients_categories/transaction/update",
                "data":_data,
                "beforeSend": showSpinningProgress($('#btn_save'))
            });
        };
        ...
        var removeCategory=function(){
            return $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Ingredients_categories/transaction/delete",
                "data":{ingredient_category_id : _selectedID}
            });
        };
